...
function EditUnitsModal({ open, handleClose, handleEditClient, title, item }) {
  ...
  useEffect(() => {
    ...
    setUnitModel({
      label: item.unitModel,
      value: item.unitModel,
    });
    setUnitJob({
      label: item.unitJobUrgency,
      value: item.unitJobUrgency,
    });
    setNote(
